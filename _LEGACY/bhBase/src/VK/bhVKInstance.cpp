...
namespace bhVk
{
	...
	VkBool32 Instance::Init()
	{
		...
		applicationInfo.applicationVersion = sys.ApplicationVersion();
		applicationInfo.engineVersion = sys.EngineVersion();
		applicationInfo.pApplicationName = sys.ApplicationName();
		applicationInfo.pEngineName = sys.EngineName();
	...
	VkBool32 Instance::InitExtensionFunctions()
	{
		VkBool32 result = VK_TRUE;

		vkCreateDebugReportCallbackEXT = (PFN_vkCreateDebugReportCallbackEXT)vkGetInstanceProcAddr(instance, "vkCreateDebugReportCallbackEXT");
		result &= vkCreateDebugReportCallbackEXT != nullptr;

		vkDestroyDebugReportCallbackEXT = (PFN_vkDestroyDebugReportCallbackEXT)vkGetInstanceProcAddr(instance, "vkDestroyDebugReportCallbackEXT");
		result &= vkDestroyDebugReportCallbackEXT != nullptr;
	...
	VkBool32 Instance::InitDebugCallback()
	{
