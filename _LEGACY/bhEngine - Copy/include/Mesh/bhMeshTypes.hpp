...
{
public:
    bhMeshSetup& AddBinding(bhMeshBindings bnd) { bindingsMask |= BH_BIT(bnd); return *this; }
    bhMeshSetup& RemoveBinding(bhMeshBindings bnd) { bindingsMask &= ~BH_BIT(bnd); return *this; }
